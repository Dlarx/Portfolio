...
const NODES = [
  ...
  { id: "excel",      label: "Excel",        angle: 143,  radius: 305, color: "#217346" },
  { id: "xampp",      label: "XAMPP",        angle: 187,  radius: 310, color: "#FB7A24" },
  { id: "datatables", label: "DataTables",   angle: 231,  radius: 305, color: "#00ACC1" },
  { id: "amcharts",   label: "amCharts",     angle: 275,  radius: 310, color: "#FF6F00" },
